...
# cross-validation version of GSE58212 microarray analysis
...
final_results <- readRDS('results/microarray/final/cv/GSE58212_cvWrapper_5.RDS')

results <- final_results$crosstalk_inhibition_results
saveRDS(results, 'results/microarray/final/cv/GSE58212_cvWrapper_5_results.RDS')
...
saveRDS(full_edges, 'results/microarray/final/cv/GSE58212_full_edges.RDS')
saveRDS(pruned_edges, 'results/microarray/final/cv/GSE58212_pruned_edges.RDS')
saveRDS(pathway_results, 'results/microarray/final/cv/GSE58212_pathway_results.RDS')
saveRDS(gene_results, 'results/microarray/final/cv/GSE58212_gene_results.RDS')

openxlsx::write.xlsx(full_edges, 'results/microarray/final/cv/GSE58212_full_edges.xlsx')
openxlsx::write.xlsx(pruned_edges, 'results/microarray/final/cv/GSE58212_pruned_edges.xlsx')
openxlsx::write.xlsx(pathway_results, 'results/microarray/final/cv/GSE58212_pathway_results.xlsx')
openxlsx::write.xlsx(gene_results, 'results/microarray/final/cv/GSE58212_gene_results.xlsx')
